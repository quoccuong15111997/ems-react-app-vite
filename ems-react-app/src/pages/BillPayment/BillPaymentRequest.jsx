...
const BillPaymentRequest = (props) => {
  const {setDisableLocation} = useStateContext();
  ...
  const updateItem = (item) => {
    let index = details.findIndex((record) => record.DetailID === item.DetailID);
    details[index] = item;
    return [...details];
  };
    ...
    const add = (dataItem) => {
     ...
     const itemChange = (event) => {
      ...
      const addNew = () => {
       ...
       const [suggestionTypeSelected, setSuggestionTypeSelected] = useState(undefined);
